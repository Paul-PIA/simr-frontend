...
const fetchCsrfToken = async () => {
    try {
        ...
        await axios.get(typeof window !=='undefined'?(window.location.origin+'/set-csrf-token'):'https://simr-backend-cyb6.onrender.com/set-csrf-token', { withCredentials: true });
